from restaurants.views import RegisterRestaurant, LoginRestaurant, ImagenRestaurant, UserToken, Logout, RestaurantUpdateAPIView, UpdateContanctAPIView, RestaurantUpdateMenuAPIView, RestaurantUpdateDescriptionAPIView, TagsRestaurantAPIView, TagsFilterListAPIView, UpdateInfoRestaurantSerializer
from django.urls import path
from restaurants.api.api import restaurant_list, imagen_list, imagen_delete, restaurant_list, tags_list_user, tags_user_delete
...
urlpatterns = [
    ...
    path('update_description/<int:pk>/',UpdateInfoRestaurantSerializer.as_view(), name = 'restaurant_update_description_api'),
