...
from restaurants.api.api import restaurant_list, imagen_list, imagen_delete
...
urlpatterns = [
    ...
    path('update_restaurant/<int:pk>',RestaurantUpdateAPIView.as_view(), name = 'restaurant_update_api'),
