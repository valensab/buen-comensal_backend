...
class RestaurantSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        print(user.check())
        restaurant = Restaurant(user= User.objects.create(email = validated_data['email'], name = validated_data['name'], is_restaurant = True, is_active = True, 
                                    last_login = timezone.now(), last_name = "", set_password(validated_data['password']), name_representative = validated_data['name_representative'],
...
class UpdateInfoSerializer(serializers.ModelSerializer):
    ...
    def update(self,instance,validated_data):
        ...
        updated_restaurant.type_food = validated_data['type_food']
        updated_restaurant.schedule = validated_data['schedule']
        updated_restaurant.vegetarian = validated_data['vegetarian']
        updated_restaurant.environment = validated_data['environment']
        updated_restaurant.active = True
        updated_restaurant.new = False
        updated_restaurant.save()
        return updated_restaurant

    class Meta:
        model = Restaurant
        fields = ['id_restaurant','schedule', 'type_food', 'vegetarian', 'environment']
