...
class Score(models.Model):
    ...
    id_user = models.ForeignKey(User,verbose_name=u'Comensal',on_delete=models.CASCADE,related_name="commensal")
...
class Comments(models.Model):
    ...
    id_user = models.ForeignKey(User,on_delete=models.CASCADE,related_name="commensal_comments", verbose_name='Comensal')
