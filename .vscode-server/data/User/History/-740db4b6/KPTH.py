...
class Score(models.Model):
    id_restaurant = models.ForeignKey('Restaurante',Restaurant,on_delete=models.CASCADE,related_name="restaurant")
    id_user = models.ForeignKey('Comensal',commensal,on_delete=models.CASCADE,related_name="commensal")
    ...
    def __str__(self):
        return f'{self.id_restaurant__user}'
