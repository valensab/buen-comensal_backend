...
class Score(models.Model):
    id_restaurant = models.ForeignKey(Restaurant,on_delete=models.CASCADE,related_name="restaurant",name='Restaurante')
    id_user = models.ForeignKey(Commensal,on_delete=models.CASCADE,related_name="commensal",name='Comensal')
