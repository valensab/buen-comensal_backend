...
from users.views import RegisterRestaurant, RegisterCommensal, LoginCommensal, LoginRestaurant, Logout
urlpatterns = [
    ...
    path('login_commensal/',LoginCommensal.as_view(), name = 'user_commensals_api'),
    path('login_commensal/',LoginRestaurant.as_view(), name = 'user_restaurant_api'),
