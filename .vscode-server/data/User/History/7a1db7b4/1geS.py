...
from users.views import  RegisterCommensal, LoginCommensal, UserToken, Logout, UpdateInfoCommensalSerializer
...
urlpatterns = [
    ...
    path('update_info/<int:pk>/',UpdateInfoCommensalSerializer.as_view(), name = 'restaurant_update_info_api'),
]