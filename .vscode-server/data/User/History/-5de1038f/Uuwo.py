...
class Restaurant(models.Model):
    ...
    schedule = models.DecimalField('Horario de atención', max_digits=10, decimal_places=3, blank = True, null = True)
...
class TagsRestaurant(models.Model):
    restaurant = models.ForeignKey(Restaurant,on_delete=models.CASCADE,related_name="tags")
    id_tags =  models.AutoField(primary_key=True, unique = True)
    tags = models.CharField("Tag", max_length=254, null = True, blank=True, unique = True)
