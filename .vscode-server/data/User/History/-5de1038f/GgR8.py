...
class Restaurant(models.Model):
    ...
    schedule = models.TimeField('Horario de atención',auto_now_add=False, auto_now=False, blank = True, null = True)
...
class FilterRestaurant(models.Model):
    restaurant = models.ForeignKey(Restaurant,on_delete=models.CASCADE,related_name="filter")
    id_tags =  models.AutoField(primary_key=True, unique = True)
    tags = models.CharField("Tag", max_length=254, null = True)
