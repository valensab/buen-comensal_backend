...
from users.api.serializers import RestaurantFieldSerializer, RestaurantSerializer, CommensalSerializer, UserTokenSerializer, CommensalFieldSerializer
...
class RegisterRestaurant(APIView):
    ...
    def post(self, request,*args,**kwargs):
        serializer = RestaurantSerializer(data= request.data.dict())
    ...
    def post(self,request,*args,**kwargs):
        ...
        if login_serializer.is_valid():
            ...
            if user is not None and user.is_active:
                ...
                user_serializer = CommensalFieldSerializer(user)
                if created and user.serializer.data['is_commensal']:
                    return Response({
                        'token': token.key,
...
class LoginRestaurant(APIView):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if login_serializer.is_valid():
            ...
            if user is not None and user.is_active:
                token,created = Token.objects.get_or_create(user = user)
                user_serializer = RestaurantFieldSerializer(user)
