...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self,email, name, last_name, password=None, **extra_fields):
        return self._create_user( email, password, name, last_name,is_active = True, is_commensal = False, is_staff =  True, is_superuser = True, is_restaurant = False, **extra_fields)
